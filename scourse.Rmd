...
par(mfrow=c(1,2))
hist(histdata2$n_steps,main = 'Imputed NAs ', xlab = 'Total number of steps',breaks = 8)

hist(histdata$n_steps,main = 'Data with NAs ', xlab = 'Total number of steps',breaks = 8,)
```
